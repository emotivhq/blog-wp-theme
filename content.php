...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		<?php the_title( sprintf( '<a href="%s" rel="bookmark"><div class="entry-title-wrap"><h1 class="entry-title">', esc_url( get_permalink() ) ), '</h1></div></a>' ); ?>
	...
	<div class="entry-content">
		...
		<?php
			wp_link_pages( array(
				'before' => '<div class="page-links">' . __( 'Pages:', 'giftstarter' ),
				'after'  => '</div>',
			) );
		?>
	</div><!-- .entry-content -->
